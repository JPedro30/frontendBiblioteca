...
export default function LibroCard({ libro, onClick }) {
  return (
    ...
    <div onClick={onClick} className="flex flex-col justify-end border-b-10 border-amber-950 w-36 sm:w-40 h-60 px-2 pb-1 relative group">
      ...
      <div className="w-full h-52 bg-zinc-800 rounded-md shadow-lg flex items-center justify-center cursor-pointer group-hover:animate-slide-out-top transition-all duration-200 overflow-hidden border border-zinc-700 group-hover:border-purple-500/50 group-hover:shadow-[0_0_15px_rgba(168,85,247,0.4)]">
